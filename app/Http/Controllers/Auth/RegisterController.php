...
class RegisterController extends Controller
{
    ...
    */
    ...
    protected function createdoc(Request $request)
    {
        ...
        Mail::to('thillangarathna@gmail.com')->send(new DoctorReqMail($data));
        return view("WaitCon");
    }
    ...
    protected function createhospital(Request $request)
    {
        ...
        Mail::to('thillangarathna@gmail.com')->send(new HospitalReqMail($data));
        return view("WaitCon");
    }
    ...
    protected function createlab(Request $request)
    {
        ...
        Mail::to('thillangarathna@gmail.com')->send(new LabReqMail($data));
        return view("WaitCon");
    }
}
